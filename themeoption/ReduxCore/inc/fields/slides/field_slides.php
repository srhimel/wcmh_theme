        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'btext' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'btext' ] ) : __ ( 'Button Text', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-btext_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][btext]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'btext' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';

                    $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'url' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'url' ] ) : __ ( 'Button Url', 'redux-framework' );
